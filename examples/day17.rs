...
fn parse_input(buffer: String) -> Vec<Line> {
    ...
    for cap in re.captures_iter(&buffer) {
        ...
        let line = if axis == 'x' {
            Line { a: Pos { x: val, y: at }, b: Pos { x: val, y: to } }
        } else {
            Line { a: Pos { y: val, x: at }, b: Pos { y: val, x: to } }
        };
        result.push(line);
    }
    result
...
fn build_grid(lines: Vec<Line>) -> Grid {
    ...
    Grid { chars, rows: ymax + 1, cols: xmax + 1 }
}
...
mod tests {
    ...
    fn test_parse() {
        ...
        let exp = vec![
            Line { a: Pos { x:495 , y:  2 }, b: Pos { x:495 , y:  7 } },
            Line { a: Pos { x:495 , y:  7 }, b: Pos { x:501 , y:  7 } },
            Line { a: Pos { x:501 , y:  3 }, b: Pos { x:501 , y:  7 } },
            Line { a: Pos { x:498 , y:  2 }, b: Pos { x:498,  y:  4 } },
            Line { a: Pos { x:506 , y:  1 }, b: Pos { x:506 , y:  2 } },
            Line { a: Pos { x:498 , y: 10 }, b: Pos { x:498 , y: 13 } },
            Line { a: Pos { x:504 , y: 10 }, b: Pos { x:504 , y: 13 } },
            Line { a: Pos { x:498 , y: 13 }, b: Pos { x:504 , y: 13 } },
        ];
